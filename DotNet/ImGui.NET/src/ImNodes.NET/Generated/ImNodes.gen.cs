...
namespace imnodesNET
{
    ...
    {
        public static void AppendDrawData(ImDrawListPtr src, Vector2 origin, float scale)
        {
            ImDrawList* native_src = src.NativePtr;
            imnodesNative.ImNodes_AppendDrawData(native_src, origin, scale);
        }
        ...
        {
            float ret = imnodesNative.ImNodes_EditorContextGetZoom();
            return ret;
        }
        ...
        public static IntPtr GetNodeEditorImGuiContext()
        {
            IntPtr ret = imnodesNative.ImNodes_GetNodeEditorImGuiContext();
            return ret;
        }
        ...
        public static void MiniMap()
        {
            ...
            ImNodesMiniMapNodeHoveringCallbackUserData node_hovering_callback_data = IntPtr.Zero;
