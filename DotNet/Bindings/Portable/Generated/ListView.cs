...
namespace Urho.Gui
{
	...
	public unsafe partial class ListView : ScrollView
	{
		...
		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern uint ListView_AddItem (IntPtr handle, IntPtr item);

		/// <summary>
		/// Add item to the end of the list.
		/// </summary>
		public uint AddItem (UIElement item)
		{
			Runtime.ValidateRefCounted (this);
			return ListView_AddItem (handle, (object)item == null ? IntPtr.Zero : item.Handle);
		}

		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern uint ListView_InsertItem (IntPtr handle, uint index, IntPtr item, IntPtr parentItem);
		...
		/// </summary>
		public uint InsertItem (uint index, UIElement item, UIElement parentItem = null)
		{
			Runtime.ValidateRefCounted (this);
			return ListView_InsertItem (handle, index, (object)item == null ? IntPtr.Zero : item.Handle, (object)parentItem == null ? IntPtr.Zero : parentItem.Handle);
		}
