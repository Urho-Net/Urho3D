...
namespace Urho
{
	...
	public unsafe partial class Node : Animatable
	{
		...
		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern void Node_RemoveComponent (IntPtr handle, int type);
		...
		{
			Runtime.ValidateRefCounted (this);
			Node_RemoveComponent (handle, type.Code);
		}
...
Node_GetNetPositionAttr
 ...
 (handle);
		...
		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern int Node_HasVar (IntPtr handle, int key);
		...
		{
			Runtime.ValidateRefCounted (this);
			return Node_HasVar (handle, key.Code);
		}

		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern int Node_HasVar28 (IntPtr handle, string key);
		...
		{
			Runtime.ValidateRefCounted (this);
			return Node_HasVar28 (handle, key);
		}
