...
namespace Urho
{
	...
	public unsafe partial class ResourceWithMetadata : Resource
	{
		...
		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern void ResourceWithMetadata_AddMetadata_8 (IntPtr handle, string name, ref Matrix3 value);

		/// <summary>
		/// Add new metadata variable or overwrite old value.
		/// 
		/// </summary>
		public void AddMetadata (string name, Matrix3 value)
		{
			Runtime.ValidateRefCounted (this);
		...
		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern void ResourceWithMetadata_AddMetadata_9 (IntPtr handle, string name, ref Matrix3x4 value);
		...
		{
			Runtime.ValidateRefCounted (this);
			ResourceWithMetadata_AddMetadata_9 (handle, name, ref value);
		}

		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern void ResourceWithMetadata_AddMetadata_10 (IntPtr handle, string name, int value);
