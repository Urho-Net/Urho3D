...
namespace Urho
{
	...
	public unsafe partial class Graphics : UrhoObject
	{
		...
		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern void Graphics_SetExternalWindowSize (IntPtr handle, ref Urho.IntVector2 position);

		/// <summary>
		/// Set external window size .i.e a window controled by external app such as Avalonia.
		/// </summary>
		public void SetExternalWindowSize (Urho.IntVector2 position)
		{
			Runtime.ValidateRefCounted (this);
			Graphics_SetExternalWindowSize (handle, ref position);
		}

		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern void Graphics_SetExternalWindowSize2 (IntPtr handle, int x, int y);

		/// <summary>
		/// Set external window size .i.e a window controled by external app such as Avalonia.
		/// </summary>
		public void SetExternalWindowSize (int x, int y)
		{
			Runtime.ValidateRefCounted (this);
			Graphics_SetExternalWindowSize2 (handle, x, y);
		}
