...
namespace Urho
{
	public static class Sdl
	{
		...
		[DllImport(Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		static extern int SDL_SendKeyboardKey(byte state, int key);
...
*/
		...
		{
			var wnd = Application.Current.Graphics.SdlWindow;
			SDL_SendWindowEvent(wnd, (byte) wndEvent, data1, data2);
		}
		...
		public static void SendKeyboardEvent(SdlKeyState state, int key) => SDL_SendKeyboardKey((byte)state, key);
	}

	//see SDL_Scancode.h
	//TODO: generate in SharpieBinder.
