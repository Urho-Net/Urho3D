...
namespace Urho.UIActions
{
	...
	public abstract class BaseAction
	{
		...
		protected internal virtual ActionState StartAction (UIElement target)
		{
			return null;
		}
	}
	...
	public abstract class ActionState
	{
		...
		public UIElement OriginalTarget { get; protected set; }
		...
		protected ActionState (BaseAction action, UIElement target)
		{
			this.Action = action;
			this.Target = target;
