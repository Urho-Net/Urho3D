...
namespace Urho
{
    ...
    public unsafe partial class Input : UrhoObject
    {
        ...
        [DllImport(Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void Input_MapCtrlQualifierToCommandKey(IntPtr handle, bool val);

        [DllImport(Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
        internal static extern bool Input_IsMapCtrlQualifierToCommandKey(IntPtr handle);

        /// <summary>
        /// OSX , maps Ctrl Qualifier to Command Key.
        /// </summary>
        public bool MapCtrlQualifierToCommandKey
        {
            set
            {
                Runtime.ValidateRefCounted(this);
                Input_MapCtrlQualifierToCommandKey(handle, value);
            }

            get
            {
                Runtime.ValidateRefCounted(this);
                return Input_IsMapCtrlQualifierToCommandKey(handle);
            }
        }
