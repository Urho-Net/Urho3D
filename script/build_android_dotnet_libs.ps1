...
# Create directories
mkdir "DotNet\libs\android\net10.0-Release\armeabi-v7a" -Force
mkdir "DotNet\libs\android\net10.0-Release\x86" -Force
mkdir "DotNet\libs\android\net10.0-Release\arm64-v8a" -Force
mkdir "DotNet\libs\android\net10.0-Release\x86_64" -Force
...
Copy-Item "android\launcher-app\build\intermediates\stripped_native_libs\release\out\lib\armeabi-v7a\libUrhoMain.so" "DotNet\libs\android\net10.0-Release\armeabi-v7a" -Force
# Copy-Item "android\launcher-app\build\intermediates\stripped_native_libs\release\out\lib\x86\libUrhoMain.so" "DotNet\libs\android\net10.0-Release\x86" -Force
Copy-Item "android\launcher-app\build\intermediates\stripped_native_libs\release\out\lib\arm64-v8a\libUrhoMain.so" "DotNet\libs\android\net10.0-Release\arm64-v8a" -Force
Copy-Item "android\launcher-app\build\intermediates\stripped_native_libs\release\out\lib\x86_64\libUrhoMain.so" "DotNet\libs\android\net10.0-Release\x86_64" -Force
