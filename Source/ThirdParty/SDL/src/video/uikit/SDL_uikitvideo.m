...
#if !TARGET_OS_TV
    // Some bug  on iOS 16 with Metal backend
    if (UIKit_IsSystemVersionAtLeast(16.0)) {
#ifndef URHO3D_ANGLE_METAL
...
#endif
#ifdef URHO3D_ANGLE_METAL
    if(screen.bounds.size.width != 0 && screen.bounds.size.height != 0)
    {
        windowdata.metalLayer.frame = screen.bounds;
    }
#endif
    return frame;
}
