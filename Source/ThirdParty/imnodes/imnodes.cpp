...
bool MouseInCanvas()
{
    ...
    */
   return GImNodes->IsHovered;//ZOOM<-
}
...
void ClickInteractionUpdate(ImNodesEditorContext& editor)
{
    ...
    case ImNodesClickInteractionType_LinkCreation:
    {
        ...
        GImNodes->CanvasDrawList->AddBezierCubic(
            ...
            //ZOOM-> GImNodes->Style.LinkThickness,
            GImNodes->Style.LinkThickness / editor.ZoomScale,//ZOOM<-
...
static void MiniMapDrawNode(ImNodesEditorContext& editor, const int node_idx)
{
    ...
    GImNodes->CanvasDrawList->AddRect(
       //ZOOM-> node_rect.Min, node_rect.Max, mini_map_node_outline, mini_map_node_rounding);
       node_rect.Min, node_rect.Max, mini_map_node_outline, mini_map_node_rounding, 0, 1 / editor.ZoomScale);//ZOOM<-
}
...
static void MiniMapDrawLink(ImNodesEditorContext& editor, const int link_idx)
{
    ...
    GImNodes->CanvasDrawList->AddBezierCubic(
        ...
        cubic_bezier.P3,
        link_color,
        //ZOOM-> GImNodes->Style.LinkThickness * editor.MiniMapScaling,
        GImNodes->Style.LinkThickness * editor.MiniMapScaling / editor.ZoomScale, //ZOOM<-
        cubic_bezier.NumSegments);
}
...
static void MiniMapUpdate()
{
    ...
    // Draw editor canvas rect inside mini-map
    {
       ...
       //ZOOM-> GImNodes->CanvasDrawList->AddRect(rect.Min, rect.Max, outline_color);
        GImNodes->CanvasDrawList->AddRect(
    ...
    ImGui::BeginGroup();
    {
        ...
        */
        ...
        memcpy(
            ...
            offsetof(ImGuiPlatformIO, Platform_SetImeDataFn) +
                sizeof(GImNodes->OriginalImgCtx->PlatformIO.Platform_SetImeDataFn));
...
{ 
    return GImNodes->NodeEditorImgCtx; 
}
