...
static int glnvg__renderCreateTexture(void* uptr, int type, int w, int h, int imageFlags, const unsigned char* data)
{
    ...
    // TBD ELI , done bu Urho3D in OGLGraphics, Causing crash on some Android devices
...
static void glnvg__renderFlush(void* uptr)
{
    ...
    glBindVertexArray(gl->vertArr);
#endif
#endif
        //TBD ELI NANOVG save initial state
        GLint paramsVertexAttribArray0 = 0;
        GLint paramsVertexAttribArray1 = 0;
        glGetVertexAttribiv(0,GL_VERTEX_ATTRIB_ARRAY_ENABLED,&paramsVertexAttribArray0);
        glGetVertexAttribiv(1,GL_VERTEX_ATTRIB_ARRAY_ENABLED,&paramsVertexAttribArray1);
        // //TBD ELI NANOVG
        ...
        //TBD ELI NANOVG , if initial state was disabled , then disable it
        if(paramsVertexAttribArray0 == 0) glDisableVertexAttribArray(0);
        if(paramsVertexAttribArray1 == 0) glDisableVertexAttribArray(1);
#if defined NANOVG_GL3
#if ! defined(URHO3D_OPENGL)
    glBindVertexArray(0);
#endif
